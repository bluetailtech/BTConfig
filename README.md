...
https://github.com/bluetailtech/BTConfig/blob/master/releases_exe/BTConfig-2020-06-29_0435.exe
...
<BR>update to 06-29_0435  Keep frequency error tacking from wandering off when in P25 mode and there is no valid signal being received.
